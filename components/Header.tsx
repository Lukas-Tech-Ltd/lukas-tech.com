...
import Logo from "./img/lukas-tech-black.png";
...
export default function Header({ navbarOpen, setNavbarOpen }: HeaderProps) {
  const menuLinkDefault =
    "font-medium text-black hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out";
